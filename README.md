**Note:** Make sure you have a backup before following this guide. Author is not responsible for any data loss and loss of time. This workflow worked for me with my own environment. This workflow may need to be adjusted for other environments and operating system versions.
